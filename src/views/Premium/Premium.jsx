...
const Premium = () => {
    ...
    const handleApprove = async (orderID, price) => {
        ...
        await dispatch(updateUserProfile(loggedUserID, { username: "Pablito" }));
    ...
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '50vh' }}>
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <PayPalScriptProvider
          options={{ 'client-id': 'AT-UuP_m-l12lYgbpzNTwHUB0O44OeEPBNht2k2wTy5MWiohCg-hcRMImfIs367iukWgQMNud4P1sz1k' }}
        >
          <PayPalButtons className='custom-button'
