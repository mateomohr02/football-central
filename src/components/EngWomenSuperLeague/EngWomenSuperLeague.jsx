...
import style from './EngWomenSuperLeague.module.css'

const EngWomenSuperLeague = () => {
  ...
  return (
    <div className={style.container}>
        <h2>TABLA DE POSICIONES DE WOMEN´S SUPER LEAGUE</h2>
...
export default EngWomenSuperLeague